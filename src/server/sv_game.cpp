...
intptr_t SV_GameSystemCalls( intptr_t *args ) {
    switch( args[0] )
    {
        ...
        case G_BOT_ALLOCATE_CLIENT: //Auriga
        ...
        case G_DEBUG_POLYGON_CREATE: //Auriga
	...
	case BOTLIB_AAS_PREDICT_CLIENT_MOVEMENT:
		return botlib_export->aas.AAS_PredictClientMovement( (aas_clientmove_s*)VMA(1), args[2], (vec_t*)VMA(3), args[4], args[5],
			(vec_t*)VMA(6), (vec_t*)VMA(7), args[8], args[9], (float)VMF(10), args[11], args[12], args[13] );
	...
	case BOTLIB_EA_DELAYED_JUMP:
		...
		return 0;
	case BOTLIB_EA_MOVE:
		botlib_export->ea.EA_Move( args[1], (vec_t*)VMA(2), (float)VMF(3) );
		return 0;
	case BOTLIB_EA_VIEW:
	...
	case BOTLIB_EA_END_REGULAR:
		botlib_export->ea.EA_EndRegular( args[1], (float)VMF(2) );
		return 0;
	case BOTLIB_EA_GET_INPUT:
		botlib_export->ea.EA_GetInput( args[1], (float)VMF(2), (bot_input_t*)VMA(3) );
		return 0;
	...
	case BOTLIB_AI_CHARACTERISTIC_BFLOAT:
		return FloatAsInt( botlib_export->ai.Characteristic_BFloat( args[1], args[2], (float)VMF(3), (float)VMF(4) ) );
	...
	case BOTLIB_AI_INITIAL_CHAT:
		botlib_export->ai.BotInitialChat( args[1], (char*)VMA(2), args[3], (char*)VMA(4), (char*)VMA(5), (char*)VMA(6), (char*)VMA(7), 
		(char*)VMA(8), (char*)VMA(9), (char*)VMA(10), (char*)VMA(11) );
		return 0;
	case BOTLIB_AI_NUM_INITIAL_CHATS:
		return botlib_export->ai.BotNumInitialChats( args[1], (char*)VMA(2) );
	case BOTLIB_AI_REPLY_CHAT:
		return botlib_export->ai.BotReplyChat( args[1], (char*)VMA(2), args[3], args[4], (char*)VMA(5), (char*)VMA(6), 
		(char*)VMA(7), (char*)VMA(8), (char*)VMA(9), (char*)VMA(10), (char*)VMA(11), (char*)VMA(12) );
	...
	case BOTLIB_AI_CHOOSE_NBG_ITEM:
		return botlib_export->ai.BotChooseNBGItem( args[1], (vec_t*)VMA(2), (int*)VMA(3), args[4], (bot_goal_s*)VMA(5), (float)VMF(6) );
	...
	case BOTLIB_AI_SET_AVOID_GOAL_TIME:
		botlib_export->ai.BotSetAvoidGoalTime( args[1], args[2], (float)VMF(3));
		return 0;
	...
	case BOTLIB_AI_MUTATE_GOAL_FUZZY_LOGIC:
		botlib_export->ai.BotMutateGoalFuzzyLogic( args[1], (float)VMF(2) );
		return 0;
	...
	case BOTLIB_AI_ADD_AVOID_SPOT:
		botlib_export->ai.BotAddAvoidSpot( args[1], (vec_t*)VMA(2), (float)VMF(3), args[4] );
		return 0;
	case BOTLIB_AI_MOVE_TO_GOAL:
		botlib_export->ai.BotMoveToGoal( (bot_moveresult_s*)VMA(1), args[2], (bot_goal_s*)VMA(3), args[4] );
		return 0;
	case BOTLIB_AI_MOVE_IN_DIRECTION:
		return botlib_export->ai.BotMoveInDirection( args[1], (vec_t*)VMA(2), (float)VMF(3), args[4] );
	...
	case BOTLIB_AI_MOVEMENT_VIEW_TARGET:
		return botlib_export->ai.BotMovementViewTarget( args[1], (bot_goal_s*)VMA(2), args[3], (float)VMF(4), (vec_t*)VMA(5) );
